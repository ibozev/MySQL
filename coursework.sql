...
CREATE TABLE drinks (
    ...
    UNIQUE (name, volume) #kamenica 500, kamenica 330
);
...
/*НА ПРАКТИКА Е ВЪЗМОЖНО ПОВТОРЕНИЕ!!!От едно вино може да има малка и голяма бутилка, но ще има референция само къмм голямата, 
логично е че малката, която е със същото име, НО друг размер, има същите съставки(сорт вино, година, винарна)*/
CREATE TABLE wines (
...
VALUES
    ...
    ('Прайд', 'пици', 600, 
		'доматен сос, луканка, шунка, пил.пушено филе, бекон, зелена чушка, гъби, лук, маслини, кашкавал, яйце', 
...
#lunchMenu; ingredienst are not nessecery
